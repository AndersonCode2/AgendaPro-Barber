                          ...
                          <div className="flex items-center justify-end mt-2">
                            {onConcluir && (
                              <button
                                ...
                                className="bg-[#D4AF37] text-[#0D0D0D] px-4 py-2 rounded-xl text-[11px] font-bold tracking-widest uppercase hover:scale-105 transition-all flex items-center gap-2"
                              >
